...
function silver_ticket() 
{
	...
	tshark -Y '((kerberos.msg_type == 14) && !(kerberos.msg_type == 12))' -r $1 -T fields -e ip.src -e ip.dst -e kerberos.KerberosString -e kerberos.cipher \
	 -E separator=+ 2>/dev/null > service_u
